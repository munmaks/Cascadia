...
public class CascadiaData {
     ...
     */
    public CascadiaData(List<Player> players, GameBoard gameBoard, TurnManager turnManager, int version) {
        this.game = new Game(players, gameBoard, turnManager, Constants.VERSION_SQUARE);
    ...
    // }
    /**
     * Changes the game state by acknowledging that the cell in column i and row
     * j has been selected.
     *
     * @param i Cell column.
     * @param j Cell row.
     ...
     *
     * @return True if the player has won by finding all pairs of objects, and
     * False otherwize.
     */
    // public boolean win() {
