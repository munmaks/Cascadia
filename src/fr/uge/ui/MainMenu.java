...
public final class MainMenu {
   ...
   * graphics.drawString("Version 1", (int) (buttonX / 1.53), (int) (buttonY *
   * 1.1));
   * graphics.drawString("With square and terminal display", (int) (buttonX /
   * 1.74), (int) (buttonY * 1.2));
   * graphics.setColor(Color.RED);
   * graphics.drawString("Version 2", (int) (buttonX * 1.15), (int) (buttonY *
   * 1.1));
   * graphics.drawString("With square and graphic display", (int) (buttonX *
   * 1.075), (int) (buttonY * 1.2));
   * graphics.setColor(Color.BLUE);
   * graphics.drawString("Version 3", (int) (buttonX * 1.65), (int) (buttonY *
   * 1.1));
   * graphics.drawString("With hexagon and graphic display", (int) (buttonX *
   * 1.57), (int) (buttonY * 1.2));
   * });
   * }
   * 
   * public void displayNumberPlayer(ApplicationContext context, int buttonX, int
   * buttonY){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.WHITE);
   * graphics.fillRect(buttonX / 2, buttonY, 300, 300);
   ...
   * graphics.fillRect((int) (buttonX * 1.5), buttonY, 300, 300);
   * graphics.setColor(Color.BLACK);
   * graphics.drawString("2 Players", (int) (buttonX / 1.53), (int) (buttonY *
   * 1.1));
   * graphics.setColor(Color.RED);
   * graphics.drawString("3 Players", (int) (buttonX * 1.15), (int) (buttonY *
   * 1.1));
   * graphics.setColor(Color.BLUE);
   * graphics.drawString("4 Players", (int) (buttonX * 1.65), (int) (buttonY *
   * 1.1));
   * });
   * }
   * 
   * public void displayVariantsChoice1(ApplicationContext context, int buttonX,
   * int buttonY) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.GRAY);
   * graphics.fillRect(buttonX / 2, buttonY, 300, 300);
   * graphics.setColor(Color.BLACK);
   * graphics.drawString("Family Variants", (int) (buttonX / 1.57), (int) (buttonY
   * * 1.1));
   * });
   * }
   * 
   * public void displayVariantsChoice2(ApplicationContext context, int buttonX,
   * int buttonY) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.GRAY);
   * graphics.fillRect(buttonX, buttonY, 300, 300);
   ...
   * }
   * 
   * public void displayVariantsChoice3(ApplicationContext context, int buttonX,
   * int buttonY) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.GRAY);
   * graphics.fillRect((int) (buttonX * 1.5), buttonY, 300, 300);
   ...
   * }
   * 
   * public void displayCardA(ApplicationContext context, int buttonX, int
   * buttonY, WildlifeType animal) {
   * context.renderFrame(graphics -> {
   ...
   * 
   * 
   * public void displayCardB(ApplicationContext context, int buttonX, int
   * buttonY, WildlifeType animal) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.DARK_GRAY);
   ...
   * }
   * 
   * public void displayCardC(ApplicationContext context, int buttonX, int
   * buttonY, WildlifeType animal) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.DARK_GRAY);
   ...
   * }
   * 
   * public void displayCardD(ApplicationContext context, int buttonX, int
   * buttonY, WildlifeType animal) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.DARK_GRAY);
   ...
   * 
   * 
   * public void displayPreviousChoice(ApplicationContext context, int bottomY,
   * int bottomButtonHeight, int bottomButtonWidth, final int version,
   * ArrayList<String> cardAnimalChoice, final int playerNumber){
   * context.renderFrame(graphics -> {
   * ArrayList<String> buttons = new ArrayList<>(Arrays.asList("Version",
   * "Salmon", "Bear", "Elk", "Hawk", "Fox", "Player"));
   ...
   * cardAnimalChoice.get(4),String.valueOf(playerNumber)));
   * for (int i = 0; i < 7; i++) {
   ...
   * (bottomY + bottomButtonHeight * 0.75));
   * }
   * });
   * }
   * 
   * public void displayEndMenu(ApplicationContext context, int buttonX, int
   * buttonY, final int version, ArrayList<String> cardAnimalChoice, final int
   * playerNumber) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   ...
   * 
   * 
   * public void checkStartOrReset(ApplicationContext context, PointerEvent.Action
   ...
   * // besoin de 7 choses, type de version (square ou hexagonal) / 5 card
   * (Wildlife type ou famille ou intermediaire) / int nombre de joueurs
   ...
   * }
   * if (action == PointerEvent.Action.POINTER_UP && location.x() >= (int)
   * (buttonX * 1.01) && location.x() <= (int) (buttonX * 1.01) + 300 &&
   * location.y() >= (int) (buttonY / 2.5) && location.y() <= (int) (buttonY /
   * 2.5) + 100) {
   * new MainMenu();
   * }
   * }
   * 
   * 
   * public boolean clickInRange(PointerEvent.Action action, PointerEvent.Location
   * location, int buttonX, int buttonY, double position){
   * return action == PointerEvent.Action.POINTER_UP &&
   * location.x() >= buttonX * position && location.x() <= buttonX * position +
   * 300 &&
   ...
   * 
   * 
   * public void checkCard(ApplicationContext context, PointerEvent.Action action,
   * PointerEvent.Location location, int buttonX, int buttonY, WildlifeType
   * animal, final int version, ArrayList<String> cardAnimalChoice) {
   ...
   * }
   * switchAnimalDisplay(context, action, location, buttonX, buttonY, animal,
   * version, cardAnimalChoice);
   * }
   * 
   * 
   * 
   * public void switchAnimalDisplay(ApplicationContext context,
   * PointerEvent.Action action, PointerEvent.Location location, int buttonX, int
   * buttonY, WildlifeType animal, final int version, ArrayList<String>
   * cardAnimalChoice) {
   * if (action == PointerEvent.Action.POINTER_UP) {
   * switch (animal) {
   * case WildlifeType.SALMON -> CardsBearChoiceMenu(context, buttonX, buttonY,
   * version, cardAnimalChoice);
   * case WildlifeType.BEAR -> CardsElkChoiceMenu(context, buttonX, buttonY,
   * version, cardAnimalChoice);
   * case WildlifeType.ELK -> CardsHawkChoiceMenu(context, buttonX, buttonY,
   * version, cardAnimalChoice);
   * case WildlifeType.HAWK -> CardsFoxChoiceMenu(context, buttonX, buttonY,
   * version, cardAnimalChoice);
   ...
   * }
   * if(player) PlayersChoiceMenu(context, buttonX, buttonY, version,
   * cardAnimalChoice);
   * }
   * if (clickInRange(action, location, buttonX, buttonY, 1)) {
   ...
   * action, PointerEvent.Location location, int buttonX, int buttonY) {
   * if (clickInRange(action, location, buttonX, buttonY, 0.5)) {
   ...
   * 
   * 
   * public void checkClickPlayer(ApplicationContext context, PointerEvent.Action
   * action, PointerEvent.Location location, int buttonX, int buttonY, final int
   * version, ArrayList<String> cardAnimalChoice) {
   * if (clickInRange(action, location, buttonX, buttonY, 0.5)) {
   * StartOrResetMenu(context, buttonX, buttonY, version, cardAnimalChoice,
   * NB_PLAYERS_SQUARE); // must do this call in a if, otherwise, it makes problem
   * }
   * if (clickInRange(action, location, buttonX, buttonY, 1)) {
   ...
   * 
   * 
   * public void VariantChoiceMenuVersion1And2(ApplicationContext context,
   * PointerEvent.Action action, PointerEvent.Location location, int buttonX, int
   * buttonY, final int version) {
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   * context.getScreenInfo().height());
   ...
   * buttonX, int buttonY, final int version){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   * context.getScreenInfo().height());
   ...
   * 
   * 
   * public void StartOrResetMenu(ApplicationContext context, int buttonX, int
   * buttonY, final int version, ArrayList<String> cardAnimalChoice, final int
   * playerNumber){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   * context.getScreenInfo().height());
   * displayEndMenu(context, buttonX, buttonY, version, cardAnimalChoice,
   * playerNumber);
   * });
   * while (true) {
   * Event event = context.pollEvent();
   ...
   * checkStartOrReset(context, action5, location5, buttonX, buttonY, version,
   * cardAnimalChoice, playerNumber);
   * }}}
   * 
   * 
   * 
   ...
   * checkClickPlayer(context, action3, location3,buttonX,buttonY, version,
   * cardAnimalChoice);
   * }}}
   * 
   * 
   * 
   * 
   * public void CardsSalmonChoiceMenu(ApplicationContext context, int buttonX,
   ...
   * checkCard(context, action4, location4,buttonX,buttonY, WildlifeType.SALMON,
   * version, cardAnimalChoice);
   * }}}
   * 
   * public void CardsBearChoiceMenu(ApplicationContext context, int buttonX, int
   * buttonY, final int version, ArrayList<String> cardAnimalChoice){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   ...
   * PointerEvent.Action action4 = pointerEvent.action();
   * PointerEvent.Location location4 = pointerEvent.location();
   * checkCard(context, action4, location4,buttonX,buttonY, WildlifeType.BEAR,
   * version, cardAnimalChoice);
   * }}}
   * 
   ...
   * PointerEvent.Action action4 = pointerEvent.action();
   * PointerEvent.Location location4 = pointerEvent.location();
   * checkCard(context, action4, location4,buttonX,buttonY, WildlifeType.ELK,
   * version, cardAnimalChoice);
   * }}}
   * 
   * public void CardsHawkChoiceMenu(ApplicationContext context, int buttonX, int
   * buttonY, final int version, ArrayList<String> cardAnimalChoice){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   ...
   * PointerEvent.Action action4 = pointerEvent.action();
   * PointerEvent.Location location4 = pointerEvent.location();
   * checkCard(context, action4, location4,buttonX,buttonY, WildlifeType.HAWK,
   * version, cardAnimalChoice);
   * }}}
   * 
   * public void CardsFoxChoiceMenu(ApplicationContext context, int buttonX, int
   * buttonY, final int version, ArrayList<String> cardAnimalChoice){
   * context.renderFrame(graphics -> {
   * graphics.setColor(Color.BLACK);
   * graphics.fillRect(0, 0, context.getScreenInfo().width(),
   ...
   * PointerEvent.Action action4 = pointerEvent.action();
   * PointerEvent.Location location4 = pointerEvent.location();
   * checkCard(context, action4, location4,buttonX,buttonY, WildlifeType.FOX,
   * version, cardAnimalChoice);
   * }}}
   * 
   * 
