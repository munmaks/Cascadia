 ...
 *
 */
public record CascadiaView(
        int xOrigin, int yOrigin,
        int height, int width,
        int squareSize, ImageLoader loader) {

    /**
     * Create a new GameView
     *
     * @param xOrigin Abscissa of the left-hand corner of the area displaying
     * the game. Abscissas are counted from left to right.
     * @param yOrigin Ordinate of the left-hand corner of the area displaying
     * the game. Ordinates are counted from top to bottom.
    ...
    /**
     * Gets row or column number based on the given coordinate and the origin of
     * the display area for this coordinate.
     *
     ...
     * @throws IllegalArgumentException if the float coordinate does not fit in
     * the game board.
     */
    ...
    /**
     * Transforms a real x-coordinate into the index of the corresponding
     * column.
     *
     ...
     * @param x Base abscissa of the part in which the image will be displayed.
     * @param y Base ordinate of the part in which the image will be displayed.
