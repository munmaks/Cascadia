 ...
 *
 */
public record CascadiaView(int xOrigin, int yOrigin, int height, int width, int squareSize, ImageLoader loader) {
   ...
   * @param data    CascadiaData storing each piece of information on the
